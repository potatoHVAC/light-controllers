...
def _post_routes():
    return {
        ...
        '/api/solo':               lambda a, d: a.solo_controller(d['mac'], d.get('dim', 0.25)),
        '/api/solo_tag':           lambda a, d: a.solo_tag(d['tag'], d.get('dim', 0.25)),
        ...
        '/api/deploy_controller':  lambda a, d: a.deploy_controller(d['mac']),
